...
Use the file generated by this command to create a new CloudFormation stack. The output of this stack includes the **Access Key ID** and **Secret Access Key** of the IAM user.
